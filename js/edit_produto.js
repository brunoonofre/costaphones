$(function(){
    ...
    button.click(function(){
        ...
        if(nomef.val() == '' ||descricaof.val() == '' || precof.val() == ''){
            successdiv.slideUp();
            errordiv.slideDown();
            ...
            $('#colors input[type=file]').each(function(){
                if($(this).val() == ""){
                    colorfoto.push($(this).next('input').val());
                }else{
            ...
            var fotoinput = $('input[name=foto]').val().replace(/C:\\fakepath\\/i, '');
            if(fotoinput == ""){
                foto=$('input[name=foto2]').val();;
            }else{
                foto=fotoinput;
            }
